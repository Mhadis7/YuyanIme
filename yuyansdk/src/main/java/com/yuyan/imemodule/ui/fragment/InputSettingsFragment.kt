...
class InputSettingsFragment: ManagedPreferenceFragment(AppPrefs.getInstance().input){
    ...
    private val fuzzyPinyinMode = AppPrefs.getInstance().input.fuzzyPinyinMode
    ...
    private val fuzzyPinyinListener = ManagedPreference.OnChangeListener<FuzzyPinyinMode> { _, _ ->
    ...
    override fun onStart() {
        ...
        fuzzyPinyinMode.registerOnChangeListener(fuzzyPinyinListener)
    }
    ...
    override fun onStop() {
        ...
        fuzzyPinyinMode.unregisterOnChangeListener(fuzzyPinyinListener)
    }
}