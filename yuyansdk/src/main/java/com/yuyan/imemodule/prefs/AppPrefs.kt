...
class AppPrefs(private val sharedPreferences: SharedPreferences) {
    ...
    inner class Input : ManagedPreferenceCategory(R.string.setting_ime_input, sharedPreferences) {
        ...
        val fuzzyPinyinMode = list(
            R.string.fuzzy_pinyin_title,
            "fuzzy_pinyin_mode",
            FuzzyPinyinMode.Off,
            FuzzyPinyinMode,
            listOf(
            ...
            listOf(
                R.string.fuzzy_pinyin_off,
                R.string.fuzzy_pinyin_simple,
                R.string.fuzzy_pinyin_comprehensive,
            )
        )
